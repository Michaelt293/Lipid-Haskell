...
instance Shorthand (TwoCombinedRadyls a) => Shorthand (PA a) where
  shorthand (PA rs) = "PA " <> shorthand rs

instance NNomenclature (TwoCombinedRadyls a) => NNomenclature (PA a) where
...
instance Shorthand (TwoCombinedRadyls a) => Shorthand (PE a) where
  shorthand (PE rs) = "PE " <> shorthand rs

instance NNomenclature (TwoCombinedRadyls a) => NNomenclature (PE a) where
...
instance Shorthand (TwoCombinedRadyls a) => Shorthand (PC a) where
  shorthand (PC rs) = "PC " <> shorthand rs

instance NNomenclature (TwoCombinedRadyls a) => NNomenclature (PC a) where
...
instance Shorthand (TwoCombinedRadyls a) => Shorthand (PG a) where
  shorthand (PG rs) = "PG " <> shorthand rs

instance NNomenclature (TwoCombinedRadyls a) => NNomenclature (PG a) where
...
instance Shorthand (TwoCombinedRadyls a) => Shorthand (PS a) where
  shorthand (PS rs) = "PS " <> shorthand rs

instance NNomenclature (TwoCombinedRadyls a) => NNomenclature (PS a) where
...
instance Shorthand (TwoCombinedRadyls a) => Shorthand (PI a) where
  shorthand (PI rs) = "PI " <> shorthand rs

instance NNomenclature (TwoCombinedRadyls a) => NNomenclature (PI a) where
...
instance Shorthand (TwoCombinedRadyls a) => Shorthand (PGP a) where
  shorthand (PGP rs) = "PGP " <> shorthand rs

instance NNomenclature (TwoCombinedRadyls a) => NNomenclature (PGP a) where
...
instance Shorthand (TwoCombinedRadyls a) => Shorthand (PIP3 a) where
  shorthand (PIP3 rs) = "PIP3 " <> shorthand rs

instance NNomenclature (TwoCombinedRadyls a) => NNomenclature (PIP3 a) where
